...
""" Same as CUBDataset, but only transformation is pad_to_multiple(32) """
...
def create_train_val_test_loaders(image_dir : str, 
    ...
    full_dataset : vanillaCUBDataset = vanillaCUBDataset(image_dir, 
                                                        segmentation_dir)
...
def generateSegmentationMasks( model : torch.nn.Module, 
    ...
    allDataloader = DataLoader(
        vanillaCUBDataset(image_dir, segmentation_dir),
        batch_size=batch_size,
        shuffle=False
    )
