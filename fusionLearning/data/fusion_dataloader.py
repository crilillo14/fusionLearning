...
class FusionDataset(Dataset):
    def __init__(self, 
        ...
        self._get_model_segmentation_paths()


    def _get_model_segmentation_paths(self):
        ...
        # append list of paths to self.model_segmentations_paths
        self.model_segmentations_paths.append(preds)
    ...
    def __getitem__(self, idx : int):
        ...
        preds, mask = load_preds(predictions_paths) , load_segmentation_mask(true_mask_path)
